...
while [ ! -f SM.pkl ] ; do
  ...
  read -p "[1]Download [2]Generate in-house: " yn
  case $yn in
    [1]* ) wget -O SM.pkl "https://studki-my.sharepoint.com/personal/dimitri_wirjowerdojo_stud_ki_se/_layouts/15/guestaccess.aspx?docid=05578af110f024b0b906aa699302ecfc5&authkey=AU3RFNSrP1axyfWKFSoCMxc" -q --show-progress ;;
